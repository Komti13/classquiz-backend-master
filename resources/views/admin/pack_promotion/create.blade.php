@extends('admin.layout.layout',['title'=>'Pack Promotion'])
@section('css')
        ...
        <div class="span12">
            <div class="grid simple ">
                <div class="grid-title">
                    <h4>Create <span class="semi-bold">Pack promotion</span></h4>
                    <div class="tools">
                ...
                <div class="grid-body ">
                    {!! Form::open(['route' => 'pack-promotions.store']) !!}
                    ...
                    <div class="checkbox checkbox check-success">
                        {!! Form::checkbox('early_bird',1,true,['id'=>'early_bird']) !!}
