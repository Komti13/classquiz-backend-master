        ...
        <div class="grid simple">
            ...
            <div class="grid-body ">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('calltype', ['Sale'=>'Sale','Feedback'=>'Feedback', 'Technical Support'=>'Technical Support'], null) !!}
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('form').submit(function(e) {
                ...
                //     call[this.name] = $(this).val();
                // });
                // console.log("valuses",values);
                // console.log("form",form.serialize())
                // localStorage.setItem('call_form', JSON.stringify(call));
                // var user = localStorage.getItem('user_form');
                // console.log(call)
