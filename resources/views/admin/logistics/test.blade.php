                                        ...
                                        <div id="rootwizard" class="col-md-12">
                                            <div class="form-wizard-steps">
                                                ...
                                                <ul class="wizard-steps">
                                                    <li class="active" data-target="#step1" id="personal">
                                                        <a href="#tab1" > <span class="step">1</span> <span class="title">Basic information</span> </a>
                                                    </li>
                                                    <li data-target="#step2" class="" id="account">
                                                        <a href="#tab2" > <span class="step">2</span> <span class="title">Account information</span> </a>
                                                    </li>
                                                    <li data-target="#step3" class="" id="payment">
                                                        <a href="#tab3" > <span class="step">3</span> <span class="title">User settings</span> </a>
                                                    </li>
                                                    <li data-target="#step4" class="" id="confirm">
                                                        <a href="#tab4" > <span class="step">4</span> <span class="title">Feedback <br>
                                                         </span> </a>
                                                    </li>
                                                </ul>
