...
<button class="btn btn-primary" id="addchild">Add new Child</button>
</div>
{{-- new child --}}
<div class="grid simple new">
    ...
    <div class="grid-body ">
        ...
        <div class="form-group">
            {!! Form::label('name', 'Name') !!}
            {!! Form::text('newchildname', null, ['class' => 'form-control', 'placeholder' => 'Name', 'id' => `name`]) !!}
        </div>
        <div class="form-group">
            {!! Form::label('level_id', 'Level') !!}
            {!! Form::select('level_id1', ['---', $levels], null, ['class' => 'levels', 'id' => 'level_id1', 'data-level-id' => '152']) !!}
        </div>
    </div>
...
<div class="grid simple new">
    ...
    <div class="grid-body ">
        <div class="form-group">
            {!! Form::label('pack', 'Pack Name') !!}
            <select name='pack1' class='packs' id='pack1'>
                <option value="---">---</option>
    ...
    <div class="form-group">
        {!! Form::label('price', 'Price') !!}
        {!! Form::text('price1', null, ['class' => 'form-control price', 'value' => '0', 'id' => 'price1']) !!}
    </div>
    <div class="form-group">
        {!! Form::label('promo_price', 'Price After Promotion') !!}
        {!! Form::text('promo_price1', null, ['class' => 'form-control price', 'value' => '0', 'id' => 'promo_price1']) !!}
    </div>
</div>
</div>
...
<div class="grid simple">
    ...
    <div class="grid-body ">
        ...
        <div class="form-group">
            ...
            {!! Form::label('label', 'Token ') !!}
            {!! Form::text('current', $token, ['class' => 'form-control', 'placeholder' => 'token for this year', 'name' => 'current', 'id' => 'current', 'disabled']) !!}
        ...
        <div class="form-group new">
            <h4>Tokens For new Child</h4>
            {!! Form::label('label', 'Current Year Token ') !!}
            {!! Form::text('current1', '', ['class' => 'form-control', 'placeholder' => 'token for this year', 'name' => 'current1', 'id' => 'current1', 'disabled']) !!}
            <div id="tokeen1" class="tokeen">
                {!! Form::label('label', 'Next Year Token ') !!}
                {!! Form::text('next1', '', ['class' => 'form-control', 'placeholder' => 'token for next year', 'name' => 'next1', 'id' => 'Next1', 'disabled']) !!}
            </div>
        </div>
        <script>
