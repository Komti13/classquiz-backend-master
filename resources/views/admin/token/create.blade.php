        ...
        <div class="span12">
            <div class="grid simple ">
                <div class="grid-title">
                    <h4>Create <span class="semi-bold">Token</span></h4>
                    <div class="tools">
                ...
                <div class="grid-body ">
                    ...
                    <div class="checkbox checkbox check-success">
                        {!! Form::checkbox('private',1,true,['id'=>'private']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('token', $generatedToken,['class'=>'form-control','placeholder'=>'Token']) !!}
