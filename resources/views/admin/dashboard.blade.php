@extends('admin.layout.layout',['title'=>'Dashboard'])
            ...
            <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
                <div class="tiles blue added-margin">
                    <div class="tiles-body">
                        ...
                        <div class="heading"><span class="animate-number" data-value="26.8"
            ...
            <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
                <div class="tiles green added-margin">
                    <div class="tiles-body">
                        ...
                        <div class="heading"><span class="animate-number" data-value="2545665"
            ...
            <div class="col-md-3 col-sm-6 spacing-bottom">
                <div class="tiles red added-margin">
                    <div class="tiles-body">
                        ...
                        <div class="heading"> $ <span class="animate-number" data-value="14500"
            ...
            <div class="col-md-3 col-sm-6">
                <div class="tiles purple added-margin">
                    <div class="tiles-body">
                        ...
                        <div class="description"><i class="icon-custom-up"></i><span
                                class="text-white mini-description ">&nbsp; 3% higher <span class="blend">than last month</span></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tiles-body">
                            <ul class="progress-list">
                                <li>
                                    ...
                                    <div class="details-status pull-right"><span class="animate-number" data-value="89"
                                ...
                                <li>
                                    ...
                                    <div class="details-status pull-right"><span class="animate-number" data-value="45"
                                ...
                                <li>
                                    ...
                                    <div class="details-status pull-right"><span class="animate-number" data-value="12"
                                                                                 data-animation-duration="200">0</span>%
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="progress progress-small no-radius">
                        ...
                        <div class="tiles white">
                            <div class="tiles-body">
                                ...
                                <div class="notification-messages info">
                                    <div class="user-profile"><img src="assets/img/profiles/c.jpg" alt=""
                                ...
                                <div class="notification-messages success">
                                    <div class="user-profile"><img src="assets/img/profiles/h.jpg" alt=""
                        ...
                        <div class="tiles white added-margin">
                            <div class="tiles-body">
                                ...
                                <div class="description"><span class="mini-description"><span
                                            class="text-black">250GB</span> of <span class="text-black">1,024GB</span> used</span>
                                </div>
                            </div>
                        </div>
                        <div class="tiles white added-margin">
                    ...
                    <div class="col-md-12 col-sm-6 spacing-bottom">
                        <div class="widget">
                            <div class="widget-title dark">
                                <div class="pull-left ">
                                    <button class="btn  btn-dark  btn-small" type="button"><i class="fa fa-plus"></i>
                                    </button>
                                </div>
                                Todo list
                                <div class="controller">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row-fluid">
                                    <div class="checkbox check-success 	">
                                        <input type="checkbox" checked="checked" value="1" id="chk_todo02"
                                               class="todo-list">
                        ...
                        <div class="tiles purple added-margin" style="max-height:345px">
                            <div class="tiles-body">
                                ...
                                <div class="blog-post-controls-wrapper">
                                    <div class="blog-post-control"><a class="text-white" href="#"><i
                                                class="icon-heart"></i> 47k</a></div>
                                    <div class="blog-post-control"><a class="text-white" href="#"><i
                                                class="icon-comment"></i> 1584</a></div>
                                </div>
                                <br>
                            </div>
                        </div>
                                    ...
                                    <div class="user-comment-wrapper col-mid-12">
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="more-details-wrapper">
                                                ...
                                                <div class="more-details"><i class="icon-map-marker"></i> Near Florida
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
