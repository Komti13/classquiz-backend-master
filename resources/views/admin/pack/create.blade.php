        ...
        <div class="span12">
            <div class="grid simple ">
                <div class="grid-title">
                    <h4>Create <span class="semi-bold">Pack</span></h4>
                    <div class="tools">
                                    ...
                                    @foreach($level->subjects as $subject)
                                        <div class="subject element">
                                            <div class="input checkbox check-success">
                                                ...
                                                {!! Form::checkbox('subjects[]',$subject->id,false,['id'=>$level->id.'-subject-'.$subject->id]) !!}
                                                {!! Form::label($level->id.'-subject-'.$subject->id,$subject->name) !!}
                                            </div>
                                            ...
                                            <div class="chapters expandable">
                                                @foreach($subject->levelChapters($level->id) as $chapter)
                                                    <div class="chapter element">
                                                        <div class="input checkbox check-success">
                                                            <a href="javascript:;" class="expand" style="visibility: hidden"><i
                                                                    class="material-icons">keyboard_arrow_right</i></a>
                                                            {!! Form::checkbox('chapters[]',$chapter->id,false,['class'=>'chapter-input','id'=>$level->id.'-chapter-'.$chapter->id]) !!}
